...
pub fn build(channel_access_token: &str, options: &Option<LineOptions>) -> RequestBuilder {
...
pub async fn execute(channel_access_token: &str, options: &Option<LineOptions>) -> Result<(ResponseBody, LineResponseHeader), Error> {
